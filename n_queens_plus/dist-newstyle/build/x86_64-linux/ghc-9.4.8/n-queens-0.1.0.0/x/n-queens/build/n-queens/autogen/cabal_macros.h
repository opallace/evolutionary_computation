...
/* package n-queens-0.1.0.0 */
#ifndef VERSION_n_queens
#define VERSION_n_queens "0.1.0.0"
#endif /* VERSION_n_queens */
#ifndef MIN_VERSION_n_queens
#define MIN_VERSION_n_queens(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_n_queens */
...
#define CURRENT_COMPONENT_ID "n-queens-0.1.0.0-inplace-n-queens"
